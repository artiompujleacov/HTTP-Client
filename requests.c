...
char *compute_get_request(char *host, char *url, char *query_params,
                            char **cookies, int cookies_count, char **tokens, int tokens_size)
{
    ...
    if (tokens != NULL) {
        ...
        strcat(line, tokens[tokens_size - 1]);
        compute_message(message,line);
    }
...
char *compute_post_request(char *host, char *url, char* content_type, char **body_data,
                            int body_data_fields_count, char **cookies, int cookies_count,char **tokens, int tokens_size)
{
    char *message = calloc(BUFLEN, sizeof(char));
    char *line = calloc(LINELEN, sizeof(char));
...
char *compute_delete_request(char *host, char *url,
                             ...
                             int cookies_count,char **tokens, int tokens_size) {
